// Searching Challenge
// Have the function
// SearchingChallenge (strArr) take the array of strings stored in strArr,
// which will be a 2D matrix of 0 and 1's, and determine how many holes,
// or contiguous regions of 0's, exist in the matrix.
// A contiguous region is one where there is a connected group of O's going in one or more of four directions: up, down, left, or right.
...
function searchingChallenge(strArr) {
  ...
  function dfs(row, col) {
    ...
    strArr[row] = strArr[row].substring(0, col) + "1" + strArr[row].substring(col + 1);
...
console.log(searchingChallenge(["10111", "10101"]));
